...
$("#inputFile").change(validateFile(["srt"]));

// Translate subtitles
$("#subtransButton").click(subTranslation);

// Call API for subtitle translation
async function subTranslation() {
    const API_URL = "https://api.trebesrv.com/translation/v1/demo/subtrans";
